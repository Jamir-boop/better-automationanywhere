...
export const AUTOMATION_ANYWHERE_SELECTOR_CHECKS: AutomationAnywhereSelectorCheck[] = [
	...
	{
		id: 'editor-palette-section',
		view: 'taskbot-editor',
		group: 'taskbot-editor',
		label: 'Palette section container',
		feature: 'Variable metadata',
		selector: EDITOR_PALETTE_SECTION_SELECTOR,
		source: 'entrypoints/content.ts',
		severity: 'optional',
		status: 'active',
	},
	{
		...
		view: 'taskbot-editor',
		group: 'taskbot-editor',
		label: 'Variable palette row',
		feature: 'Variable metadata',
		selector: VARIABLE_ROW_SELECTOR,
		source: 'entrypoints/content.ts',
		severity: 'optional',
		status: 'active',
		triggerHint: 'Open the Variables palette section to render variable rows.',
	},
	{
		id: 'variable-label',
		view: 'taskbot-editor',
		...
		feature: 'Variable metadata',
		selector: VARIABLE_LABEL_SELECTOR,
		source: 'entrypoints/content.ts',
		severity: 'optional',
		status: 'active',
		triggerHint: 'Open the Variables palette section to render variable rows.',
	...
	{
		id: 'variable-label-text',
		view: 'taskbot-editor',
		group: 'taskbot-editor',
		label: 'Variable label text node',
		feature: 'Variable metadata',
		selector: VARIABLE_LABEL_TEXT_SELECTOR,
		source: 'entrypoints/content.ts',
		severity: 'optional',
		status: 'active',
		triggerHint: 'Open the Variables palette section to render variable rows.',
	...
	},
	{
		...
		feature: 'Universal clipboard and browser context menu',
